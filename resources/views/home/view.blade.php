            ...
            <div class="row">
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="category">
                        ...
                        <div class="menu">
                            <ul>
                                ...
                                @foreach($cats as $cat)
                                <li><a href="{{route('view',['id'=>$cat->id,'slug'=>$cat->slug])}}">{{$cat->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="refine_search">
                        ...
                        <div class="feature">
                            <h4 style="font-weight: bold; margin-top:50px; margin-bottom: 25px;">Feature</h4>
                            <form action="{{route('shop')}}" method="GET" role="form">
                                <input type="hidden" name="cat_id" value="{{$cate->id}}">
                        ...
                        <div class="price">
                            ...
                            <input type="submit" class="filter" data-inline="true" value="Submit">
                            </form>
                        </div>
                    </div>
                    <div class="sale">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                    <div class="thumbnail pro-item">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>{{$pro->name}}</p>
                                            @if($pro->sale_price)
                                            <strike>{{number_format($pro->price)}}$</strike>
                                            <strong> {{number_format($pro->sale_price)}}$</strong>
                                            @else()
                                            <strong>{{number_format($pro->price,2)}}$</strong>
                                            @endif
                                ...
                                <div class="thumbnail pro-item">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="caption">
                                                <div class="row">
                                                    <div class="col-xs-6"><span>Palettes</span></div>
                                                    <div class="col-xs-6 text-right"><select class="star-rating">
                                                            <option
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div id="owl-modal" class="owl-carousel owl-theme">
                        <div class="item">
                            <a title="">
                        ...
                        <div class="item">
                            <a title="">
                                <img src="{{url('public/home')}}/image/images/01_04_Home_30_02.png" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a title="">
                                <img src="{{url('public/home')}}/image/images/01_04_Home_30_03.png" alt="">
                            </a>
                        </div>
                        <div class="item">
                            <a title="">
