        ...
        <form action="{{route('admin.Blog.update',$blog->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="mytextarea" class="form-control" cols="30" rows="10">{{$blog->content}}</textarea>
                </div>
                @error('content')
                <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            ...
            <div class="col-md-4">
                ...
                <label for="">Image</label>
                    ...
                    <div class="form-group">
                        <img src="{{url('public/image')}}/{{$blog->image}}" id="show" width="100%" alt="">
                    </div>
                </div>
                @error('image')
                <div class="alert alert-warning">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control">
                        ...
                        <input type="radio" name="status" value="1"{{$blog->status==1?'checked':''}}> Show
                        <input type="radio" name="status" value="0"{{$blog->status==0?'checked':''}}> Hidden
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="meta_desc" value="{{$blog->meta_desc}}">
                </div>
                @error('meta_desc')
                <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="meta_key" value="{{$blog->meta_key}}">
                </div>
                @error('meta_key')
                <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
