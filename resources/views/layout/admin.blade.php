...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
        href="{{url('public/Admin')}}/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="{{url('public/Admin')}}/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  ...
  <![endif]-->
    ...
    <script type="text/javascript">
    var akey = function() {
        return "{{'JDmgWEZBvxs9fYw6jRK7qsB5QJnafF4ig39kw4ygs'}}";
    }
    </script>
...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{{url('public/Admin')}}/dist/img/user3-128x128.jpg"
                                                        class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{{url('public/Admin')}}/dist/img/user4-128x128.jpg"
                                                        class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Developers
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    ...
                                                    @else
                                                    <img class="img-circle"
                                                        src="{{url('public/home/avatars/default.jpg')}}">
                                                    @endif
                                                </div>
                                                <h4>
                                                    Reviewers
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                @if(Auth::user()->avatar)
                                <img class="user-image" src="{{url('public/home/avatars/')}}/{{Auth::user()->avatar}}">
                                @else
                                <img class="user-image" src="{{url('public/home/avatars/default.jpg')}}">
                                @endif
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{route('info')}}" class="btn btn-default btn-flat">Profile</a>
                                    </div>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        @if(Auth::user()->avatar)
                        <img class="img-circle" src="{{url('public/home/avatars/')}}/{{Auth::user()->avatar}}">
                        @else
                        <img class="img-circle" src="{{url('public/home/avatars/default.jpg')}}">
                        @endif
                    </div>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{route('admin.Brand.index')}}"><i class="fa fa-circle-o"></i> Brand</a></li>
                            @endif
                            @if(Auth::user()->can('admin.Blog.index'))
                            <li><a href="{{route('admin.Blog.index')}}"><i class="fa fa-circle-o"></i> Blog</a></li>
                            @endif
                            @if(Auth::user()->can('admin.Banner.index'))
                            <li><a href="{{route('admin.Banner.index')}}"><i class="fa fa-circle-o"></i> Banner</a></li>
                            @endif
                            @if(Auth::user()->can('admin.Category.index'))
                            <li><a href="{{route('admin.Category.index')}}"><i class="fa fa-circle-o"></i> Category</a>
                            </li>
                            @endif
                            @if(Auth::user()->can('admin.Comment.index'))
                            <li><a href="{{route('admin.Comment.index')}}"><i class="fa fa-circle-o"></i> Comment</a>
                            </li>
                            @endif
                            @if(Auth::user()->can('admin.Client.index'))
                            <li><a href="{{route('admin.Client.index')}}"><i class="fa fa-circle-o"></i> Client</a></li>
                            @endif
                            @if(Auth::user()->can('admin.Contact.index'))
                            <li><a href="{{route('admin.Contact.index')}}"><i class="fa fa-circle-o"></i> Contact</a>
                            </li>
                            @endif
                            @if(Auth::user()->can('admin.Color.index'))
                            <li><a href="{{route('admin.Color.index')}}"><i class="fa fa-circle-o"></i> Color</a></li>
                            @endif
                            @if(Auth::user()->can('admin.Product.index'))
                            <li><a href="{{route('admin.Product.index')}}"><i class="fa fa-circle-o"></i> Product</a>
                            </li>
                            @endif
                            @if(Auth::user()->can('admin.Payment.index'))
                            <li><a href="{{route('admin.Payment.index')}}"><i class="fa fa-circle-o"></i> Payment</a>
                            </li>
                            @endif
                            @if(Auth::user()->can('admin.Quote.index'))
                            <li><a href="{{route('admin.Quote.index')}}"><i class="fa fa-circle-o"></i> Quote</a></li>
                            @endif
                            @if(Auth::user()->can('admin.Role.index'))
                            <li><a href="{{route('admin.Role.index')}}"><i class="fa fa-circle-o"></i> Role</a></li>
                            @endif
                            @if(Auth::user()->can('admin.Shipping.index'))
                            <li><a href="{{route('admin.Shipping.index')}}"><i class="fa fa-circle-o"></i> Shipping</a>
                            </li>
                            @endif
                            @if(Auth::user()->can('admin.Subcriber.index'))
                            <li><a href="{{route('admin.Subcriber.index')}}"><i class="fa fa-circle-o"></i>
                                    Subcriber</a></li>
                            @endif
    ...
    <!-- datepicker -->
    <script src="{{url('public/Admin')}}/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js">
    </script>
    <!-- Bootstrap WYSIHTML5 -->
